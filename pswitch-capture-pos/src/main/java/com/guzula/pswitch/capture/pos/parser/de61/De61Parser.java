...
public final class De61Parser implements FieldValueDecoder {
    ...
    private Subfield parseSubfield(BcdSubfield subfield) {
        return switch (subfield.id()) {
            ...
            case "02" -> new Subfield("02", "Numero de Serie do POS", parsePosSerialNumber(subfield.body()));
            case "08" -> new Subfield("08", "Financiamento e Pre-datamento", parseFinancing(subfield.body()));
            case "14" -> new Subfield("14", "Codigo do Produto Matriz", parseMatrixProduct(subfield.body()));
            case "16" -> new Subfield("16", "Identificacao Positiva", parsePositiveIdentification(subfield.body()));
            case "28" -> new Subfield("28", "Codigo do Produto Secundario", parseSecondaryProduct(subfield.body()));
    ...
    private FinancingData parseFinancing(byte[] body) {
        ...
        String financingDescription = switch (financingCode) {

...
/**
 * Fonte única de verdade para encode/decode de campos ISO 8583. Referência: parseIsoField /
 * packIsoField em src/shared/utils/iso-codec.ts (guzula-switch).
 *
 * <p>TODO: portar a lógica de parse/pack por IsoFieldType (BCD, BCN, BCZ, TLV, EBCDIC...).
 */
public final class IsoCodec {
  ...
  public static byte[] packIsoField(
      String value, IsoFieldType type, Integer length, boolean rightPad) {

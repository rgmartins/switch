...
/**
 * Referência: visa.service.ts (guzula-switch).
 * Correlaciona request/response outbound por RRN (via Redis, no original).
 *
 * TODO: portar envio outbound (pswitch-transport) e correlação de resposta.
 */
@Service

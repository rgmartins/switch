 ...
 *
 * Nota (TODO.md do projeto original): campo `valor` está como Float — decisão
 * tomada é migrar para inteiro (centavos) em todo o pipeline financeiro.
 * Ao portar, já modelar o valor como long (centavos), sem repetir o float.
 */
@Service

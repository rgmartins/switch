 ...
 *
 * <p>Nota (TODO.md do projeto original): trocar upsert por create para detectar NSU duplicado
 * explicitamente, e disparar reversal automático (MTI 0420) se a persistência falhar após aprovação
 * da bandeira — ver risco financeiro descrito lá.
 */
@Service
